...
#define ltc6804_RESET_PIN  	GPIO_PIN_8//GPIO_Pin_12
#define ltc6804_RESET_PORT	GPIOC

#define ltc6804_CS_PIN      GPIO_PIN_12//GPIO_Pin_4
#define ltc6804_CS_PORT			GPIOC
#define ltc6804_MOSI_PIN    GPIO_PIN_5//GPIO_Pin_6
#define ltc6804_MOSI_PORT		GPIOB
#define ltc6804_MISO_PIN    GPIO_PIN_4//GPIO_Pin_5
#define ltc6804_MISO_PORT		GPIOB
#define ltc6804_SCK_PIN	    GPIO_PIN_3//GPIO_Pin_2
#define ltc6804_SCK_PORT		GPIOB

#define ltc6804_SCK_SET		HAL_GPIO_WritePin(ltc6804_SCK_PORT, ltc6804_SCK_PIN, GPIO_PIN_SET)
#define ltc6804_SCK_RESET	HAL_GPIO_WritePin(ltc6804_SCK_PORT, ltc6804_SCK_PIN, GPIO_PIN_RESET)

#define ltc6804_CS_SET(X)	HAL_GPIO_WritePin(ltc6804_CS_PORT, X, GPIO_PIN_SET)
#define ltc6804_CS_RESET(X)	HAL_GPIO_WritePin(ltc6804_CS_PORT, X, GPIO_PIN_RESET)

#define ltc6804_MOSI_SET	HAL_GPIO_WritePin(ltc6804_MOSI_PORT, ltc6804_MOSI_PIN, GPIO_PIN_SET)
#define ltc6804_MOSI_RESET	HAL_GPIO_WritePin(ltc6804_MOSI_PORT, ltc6804_MOSI_PIN, GPIO_PIN_RESET)

#define ltc6804_MISO		HAL_GPIO_ReadPin(ltc6804_MISO_PORT, ltc6804_MISO_PIN)

#define ltc6804_RESET_HIGH	HAL_GPIO_WritePin(ltc6804_RESET_PORT, ltc6804_RESET_PIN, GPIO_PIN_SET);//GPIOE->BSRRL = ltc6804_RESET_PIN;
#define ltc6804_RESET_LOW	HAL_GPIO_WritePin(ltc6804_RESET_PORT, ltc6804_RESET_PIN, GPIO_PIN_RESET);//GPIOE->BSRRH = ltc6804_RESET_PIN;

#define VBATT_BALANCE_START 33
#define VCELL_BALANCE_PERMITTED 3.3

void ltc6804_Config(void);
...
//void LTC6804_rdstata( uint8_t data_out[8]);
